...
serve(async (req) => {
  ...
  try {
    ...
    const { amount, description, productName } = await req.json();
    console.log("[CREATE-PAYMENT] Payment details:", { amount, description, productName });
